    ...
    return Container(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          final webnovelEpisode = _webnovelEpisodes[index];

          // Create a temporary Episode object that EpisodeListTile can use
          final episode = episode_model.Episode(
            id: webnovelEpisode.id,
            title: webnovelEpisode.title,
            number: index + 1, // Use index+1 as the episode number
            images: [], // Webnovels don't have images
            previewImage: widget.comic.coverImage, // Use comic cover as preview
          );
