...
class _OnboardingWelcomeState extends State<OnboardingWelcome> {
  ...
  void _validateUsername(String username) async {
    ...
    try {
      ...
      setState(() {
        _isValidating = false;
        _usernameError = 'Error validating username. Please try again.';
      });
    }
  }

  void _onGetStarted() async {
    if (_usernameController.text.isEmpty || _selectedGenres.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('Please enter a username and select at least one genre'),
  ...
  Widget build(BuildContext context) {
    ...
    final bool isButtonEnabled = _usernameController.text.isNotEmpty && 
